...
<!--内容-->
    ...
    <div class="breadcrumbs" id="breadcrumbs">
       ...
       <div class="breadcrumb_style clearfix">
	     <ul class="breadcrumb clearfix" id="min_title_list">
          <li class="active home"><span title="我的桌面" data-href="/stock/init"><i class="fa fa-home home-icon"></i>首页</span></li>
         </ul>
      </div>
  ...
  <div class="show_iframe index_home" id="show_iframe">
       <iframe scrolling="yes" class="simei_iframe" frameborder="0" src="/stock/init" name="iframepage" ></iframe>
       </div>
      </div>
  </div>
<!--底部-->
  <div class="Sellerber_bottom info" id="bottom">
  <#--<span class="l_f">版权所有：苏州市诺莱声科技有限公司</span>-->
  </div>
 </div>
</body>
</html>
